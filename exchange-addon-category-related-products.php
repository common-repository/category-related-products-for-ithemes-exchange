 ...
 * Text Domain: category-related-products-for-ithemes-exchange
*/
 ...
 * @since 1.0.0
*/
define( 'IT_Exchange_Category_Related_Products_Version', '1.0.2' );
...
function it_exchange_register_category_related_products_addon() {
	$options = array(
		'name'              => __( 'Category Related Products', 'category-related-products-for-ithemes-exchange' ),
		'description'       => __( 'Display related products based on iThemes Exchange product categories.', 'category-related-products-for-ithemes-exchange' ),
		'author'            => 'Ty Carlson',

...
function it_exchange_category_related_products_addon_print_settings() {
	...
	<div class="wrap">
		...
		<h2><?php _e( 'Category Related Products Settings', 'category-related-products-for-ithemes-exchange' ); ?></h2>
		...
		if ( ! empty( $_POST['__it-form-prefix'] ) && 'it-exchange-addon-category-related-products' == $_POST['__it-form-prefix'] )
			ITUtility::show_status_message( __( 'Options Saved', 'category-related-products-for-ithemes-exchange' ) );
		...
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th scope="row"><label for="category-related-products-count"><?php _e( 'Related Products Count', 'category-related-products-for-ithemes-exchange' ) ?></label></th>
					<td>
						<?php 
							$field_options = array(
								'id'      => 'count',
						...
						<label for="category-related-products-count">
							<span class="description"><?php _e( 'How many related products would you like to display?', 'category-related-products-for-ithemes-exchange' ); ?></span>
						</label>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row"><label for="category-related-products-width"><?php _e( 'Related Product Width', 'category-related-products-for-ithemes-exchange' ) ?></label></th>
					<td>
						<?php 
							$field_options = array(
								'id'      => 'width-int',
						...
						<label for="category-related-products-width">
							<span class="description"><?php _e( 'Width of each product in the related products list', 'category-related-products-for-ithemes-exchange' ); ?></span>
						</label>
					</td>
				</tr>
			</tbody>
